    ...
    <div className="mx-auto bg-white">
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-2 lg:px-8">
          <div className="relative z-10 mx-auto flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
...
export const getServerSideProps: GetServerSideProps = async () => {
  const notes = await prisma.books.findMany({
    select: {
      title: true,
      author: true,
      category: true,
